...
- Create Angular project with ng: `ng new simplepresave.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`simplepresave.client.esproj`).
